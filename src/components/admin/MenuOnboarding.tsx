        ...
        {currentStep === 'check' && (
          <div className="h-full">
            {menuSynced === null ? (
              ...
              // Menu already synced - show menu items list (full width)
              <div className="animate-fade-in">
                <div className="mb-4 flex items-center justify-between glass-panel p-4 rounded-xl border border-border">
