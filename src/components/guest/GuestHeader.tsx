...
export function GuestHeader({
  ...
  return (
    <header className="sticky top-0 z-50 bg-card border-b border shadow-sm">
      <div className="flex items-center justify-between px-4 py-3">
        ...
        <button
          onClick={onCartClick}
          className="relative p-2 rounded-full bg-accent/10 hover:bg-accent/20 transition-colors"
