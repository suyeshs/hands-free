...
export const GlassCard: React.FC<GlassCardProps> = ({
  ...
  if (variant === 'panel') {
    ...
    variantClasses = "bg-warm-charcoal/80 border border-white/10 shadow-2xl";
  } else if (variant === 'feature') {
    variantClasses = "bg-gradient-to-br from-white/[0.05] to-transparent border border-white/[0.05]";
  }

  const hoverClasses = hoverEffect ? "hover:bg-white/[0.06] hover:border-white/[0.15] hover:shadow-[0_12px_48px_rgba(0,0,0,0.4)] hover:-translate-y-1" : "";
