/**
 * BDS Floating Orb Component
 * A floating action button for the Bar Display System
...
export function BDSFloatingOrb({
  isOpen,
  onToggle,
  activeOrderCount,
  urgentOrderCount,
  ...
  const menuItems: BDSOrbMenuItem[] = [
    {
      id: 'home',
      icon: Home,
      label: 'Home',
  ...
  const handleItemClick = (item: BDSOrbMenuItem) => {
    item.onClick();
      ...
      >
        ...
        <motion.button
          className={cn(
            ...
            'bg-purple-800 border-2 border-purple-600 shadow-xl touch-target-lg',
            'transition-colors',
            isOpen ? 'bg-purple-700' : 'bg-purple-800'
          )}
          style={{
