...
CREATE INDEX idx_vision_cameras_tenant ON vision_cameras(tenant_id);
CREATE INDEX idx_vision_cameras_location ON vision_cameras(location);
...
CREATE INDEX idx_vision_detections_camera ON vision_detections(camera_id, timestamp DESC);
CREATE INDEX idx_vision_detections_tenant ON vision_detections(tenant_id, timestamp DESC);
...
CREATE INDEX idx_vision_events_camera ON vision_events(camera_id, timestamp DESC);
CREATE INDEX idx_vision_events_tenant ON vision_events(tenant_id, timestamp DESC);
CREATE INDEX idx_vision_events_type ON vision_events(event_type);
CREATE INDEX idx_vision_events_severity ON vision_events(severity);
CREATE INDEX idx_vision_events_acknowledged ON vision_events(acknowledged);
...
CREATE INDEX idx_vision_snapshots_camera ON vision_snapshots(camera_id, timestamp DESC);
CREATE INDEX idx_vision_snapshots_tenant ON vision_snapshots(tenant_id, timestamp DESC);
CREATE INDEX idx_vision_snapshots_r2_key ON vision_snapshots(r2_key);
...
CREATE INDEX idx_vision_analytics_camera ON vision_analytics_hourly(camera_id, hour_timestamp DESC);
CREATE INDEX idx_vision_analytics_tenant ON vision_analytics_hourly(tenant_id, hour_timestamp DESC);
CREATE INDEX idx_vision_analytics_location ON vision_analytics_hourly(location, hour_timestamp DESC);
