-- Google Reviews Table Schema
-- ADD THIS TO EACH TENANT'S D1 DATABASE SCHEMA
-- Stores synced reviews from Google Places for this specific tenant

CREATE TABLE IF NOT EXISTS google_reviews (
  -- Primary Key
  id TEXT PRIMARY KEY, -- Format: {place_id}_{timestamp}

  -- Place ID (this tenant's Google Place)
