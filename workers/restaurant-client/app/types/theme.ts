...
export interface MultimodalRestaurantTheme {
  ...
  meta: {
    ...
    version: string;
    tags: string[];
    /** Display name for voice greetings */
    displayName?: string;
  ...
  components?: {
    ...
    promoCarousel?: ComponentConfig & { items?: any[] };
    /** Marketing carousel for offers and communications */
    marketingCarousel?: ComponentConfig & { items?: any[] };
    /** Inline promo carousel below category pills */
    inlinePromoCarousel?: ComponentConfig & { items?: any[] };
