...
import { Step1RestaurantInfo } from '@/app/components/admin/setup-flow/Step1RestaurantInfo';

/**
 * Restaurant Information Editor Page
 * Allows editing of restaurant details
 */
export default function RestaurantInfoPage() {
  ...
  const handleSave = async () => {
    ...
    setTimeout(() => {
      setIsSaving(false);
      alert('Restaurant information saved! (Save functionality to be implemented)');
    }, 1000);
  };
      ...
      <div className="min-h-screen bg-neu-bg">
        ...
        <div className="bg-white shadow">
          <div className="max-w-5xl mx-auto px-6 py-4 flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-neu-text">Restaurant Information</h1>
        ...
        <div className="max-w-5xl mx-auto px-6 py-8">
          ...
          <div className="mt-6 flex justify-end">
            ...
            >
              {isSaving ? 'Saving Restaurant Info...' : 'Save Restaurant Info'}
            </button>
          </div>
        </div>
      </div>
