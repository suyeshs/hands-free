...
import { Truck, ShoppingBag, Utensils, CreditCard } from 'lucide-react';
...
export const OrderTypeSelection = observer(function OrderTypeSelection({
  ...
  // Payment method fixed to 'online' - cash on delivery option removed
    ...
    <div className="h-full flex flex-col bg-gradient-to-b from-white/95 to-gray-50/95 backdrop-blur-xl">
      ...
      <div className="flex-1 overflow-y-auto px-6 space-y-6">
        ...
        <div>
          ...
          <div className="bg-blue-50/60 border-2 border-blue-500 p-4 rounded-xl">
            <div className="flex items-center gap-3">
