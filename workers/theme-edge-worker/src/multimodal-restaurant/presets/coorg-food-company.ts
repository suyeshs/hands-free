    ...
    marketingCarousel: createPromoCarousel({
      ...
      items: [
        // Launch offer
        {
          ...
          description: 'Use code COORG20 at checkout for 20% off your first order',
          icon: '🎁',
        ...
        // Combo deal
        {
          ...
          subtitle: 'Save ₹200',
          description: '2 Mains + 2 Sides + 4 Rotis + 2 Desserts at special price',
          icon: '👨‍👩‍👧‍👦',
        ...
        // Happy hours
        {
          id: 'happy-hours',
          type: 'announcement',
          title: 'Happy Hours: 3PM - 6PM',
          subtitle: 'Daily Offer',
          description: 'Flat 15% off on all beverages and snacks during happy hours',
          icon: '⏰',
          ...
          action: {
            type: 'link',
            target: '/menu?category=beverages',
            label: 'View Beverages',
          },
          badge: {
            text: '15% OFF',
            color: '#78350f',
        ...
        // Loyalty program
        {
          id: 'loyalty-program',
          type: 'announcement',
          title: 'Join Coorg Rewards',
          subtitle: 'Earn Points on Every Order',
          description: 'Get 1 point per ₹10 spent. Redeem for free dishes!',
          icon: '⭐',
        ...
        // Seasonal special
        {
          id: 'seasonal-special',
          type: 'special',
          title: 'Pandi Curry Festival',
          subtitle: 'Authentic Coorg Delicacy',
          description: 'Traditional Kodava pork curry prepared with secret family recipes',
          icon: '🍛',
        ...
        // Free delivery
        {
          ...
          description: 'Enjoy free delivery on all orders within 5km radius',
          icon: '🛵',
