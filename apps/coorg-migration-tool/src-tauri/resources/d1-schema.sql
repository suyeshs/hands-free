...
-- =========================================
-- COORG MIGRATION TOOL INITIALIZATION
-- =========================================
-- This section initializes the Coorg Food Company tenant configuration
-- after the database schema has been created.

-- Mark migrations as applied (prevent re-run in production app)
INSERT OR IGNORE INTO schema_migrations (version, name, source, checksum, applied_at, app_version)
VALUES
    (1, '001_initial_schema', 'migration-tool', 'coorg-migration-v3.1.4', strftime('%s', 'now'), '3.1.4'),
    (53, '053_minimal_tenant_config', 'migration-tool', 'coorg-migration-v3.1.4', strftime('%s', 'now'), '3.1.4');

-- Initialize tenant configuration for Coorg Food Company
...
-- Initialize restaurant settings (will be updated by migration tool with actual data)
-- This ensures the table exists and has a default row
INSERT OR IGNORE INTO restaurant_settings (id) VALUES (1);

-- End of Coorg Migration Tool Initialization
