...
fn generate_extractor_script(app: &AppHandle, platform: &str) -> Result<String, String> {
...
pub async fn reload_dashboard(app: AppHandle, platform: String) -> Result<(), String> {
    ...
    match platform.to_lowercase().as_str() {
        "swiggy" => open_swiggy_dashboard(app).await,
        "zomato" => open_zomato_dashboard(app).await,
